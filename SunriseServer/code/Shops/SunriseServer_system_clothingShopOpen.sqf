/*
	...
	Filename: 	SunriseServer_system_clothingShopOpen.sqf
...
[_shop, (shops_array select _shop_index) select 1] remoteExecCall ["SunriseClient_system_clothingMenuOpen",_unit];
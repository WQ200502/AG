/*
	...
	Filename:   SunriseServer_system_copGoOnDuty.sqf
...
format ["invitePlayer:%1:%2",(life_copGroup getVariable ["gang_id",-1]),_player_uid] call SunriseServer_database_fireAndForget;
...
format["updatePlayerIndCfg_life_copDuty:true:%1",_player_uid] call SunriseServer_database_fireAndForget;

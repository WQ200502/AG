...
_nearche = player nearEntities ["Car", 50];
_logplayers = [];
...
uiSleep 4.5;
player,format["%1 向车辆人员 %2 发送了打劫警告并进入战斗区域", name player, _logplayers];
uiSleep 60;
player,format["%1 向车辆人员 %2 的战斗已解除不能再射击", name player, _logplayers];
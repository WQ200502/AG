...
else
{
	...
	
	{
		if((_x select 0) == _shortname) exitWith
		{
			...
			{
				ctrlSetText [1200, "\anzuslifecore\images\icons\trendup.paa"];
			}
			else
			{
				ctrlSetText [1200, "\anzuslifecore\images\icons\trenddown.paa"];
			};
			...
			{
				ctrlSetText [1201, "\anzuslifecore\images\icons\trendup.paa"];
			}
			else
			{
				ctrlSetText [1201, "\anzuslifecore\images\icons\trenddown.paa"];
			};
		};
	}

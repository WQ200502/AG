...
if (decryptingData) exitWith {["你已经这么做了！",true,"slow"] call ANZUS_fnc_notificationSystem;};
...
publicVariable "dbBreaching"; decryptingData = false;};
...
["你已经下载了数据，它是加密的，解密下载在主机上。",true,"slow"] call ANZUS_fnc_notificationSystem;

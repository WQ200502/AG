...
_details = [_item] call ANZUS_fnc_fetchCfgDetails;
    ...
    switch (_details select 6) do {
        ...
        case "CfgVehicles": {
            ...
            if (!isNil "_items") then {
                {[_x,true,true,false,true] call ANZUS_fnc_handleItem; } forEach _items;
            };
        };
                ...
                switch (_details select 5) do {
                        ...
                        if (_ispack) then {
                            ...
                            if (_override) then{
                                ...
                                if (vest player isEqualTo _item && {!_preview}) then {
                                    ...
                                    if (!isNil "_items") then {
                                        {[_x,true,false,false,true] spawn ANZUS_fnc_handleItem;} forEach _items;
                                    };
                                };
                            };
                        };
                    ...
                    case 201: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,201] call ANZUS_fnc_accType;
                            if (_ongun) then {
                                switch (_type) do {
                                ...
                                if (_override) then {
                                    ...
                                    if (_slotTaken) then {
                                        _action = [localize "STR_MISC_Attachment", localize "STR_MISC_AttachmentMSG", localize "STR_MISC_Weapon", localize "STR_MISC_Inventory", findDisplay 46, true] call ANZUS_fnc_guiPrompt;
                    ...
                    case 301: {
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,301] call ANZUS_fnc_accType;
                    ...
                    case 101:{
                        if (_ispack) then {
                            ...
                            private "_type";
                            _type = [_item,101] call ANZUS_fnc_accType;

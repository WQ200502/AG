...
_paraClass = (configfile >> "CfgVehicles" >> _veh >> "TransportBackpacks" >> "_xx_B_Parachute"); 
if (isClass _paraClass) then { 
 _vehicle addBackpackCargoGlobal [getText (_paraClass >> "backpack"),getNumber (_paraClass >> "count")]; 
};
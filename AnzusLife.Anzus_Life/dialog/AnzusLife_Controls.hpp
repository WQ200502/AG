...
class ANZUS_ctrlContentAreaTexturedButton: ANZUS_RscButtonMenu {
    animTextureDefault 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureDisabled 		= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTexturePressed 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureNormal 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    textureNoShortcut 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureNormal.paa";
    animTextureFocused 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureFocus.paa";
    animTextureOver 			= "\AnzusLifeCore\images\displays\DISPLAYMenu\buttonTextureFocus.paa";
    color2[] 					= {1, 1, 1, 0.5};
    color[] 					= {1, 1, 1, 1};
    colorBackground2[] 			= {1, 1, 1, 1};
